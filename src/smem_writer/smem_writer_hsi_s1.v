...
(
    ...
    // An async signal that tells us the FIFO is empty
    input             async_fifo_empty,
...
always @* begin
    case (fsm_state)
        ...
        FSM_EMIT_DATA: axis_out_tdata = element[word_number];
...
//=============================================================================
// Synchronize "async_fifo_empty" into "fifo_empty"
//=============================================================================
xpm_cdc_single #
(
    .DEST_SYNC_FF  (4),
