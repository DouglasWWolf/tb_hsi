...
module smem_writer_imp_ZNAGWC
  ...
  wire [63:0]fetch_abm_M_SHA_WSTRB;
  wire fetch_abm_M_SHA_WVALID;
  wire [511:0]fetch_abm_smem_data4;
  wire [511:0]fetch_abm_smem_data5;
  wire [511:0]fetch_abm_smem_data6;
  wire [511:0]fetch_abm_smem_data7;
  ...
  assign force_cache_update_1 = force_smem_update;
  ...
  top_level_fetch_abm_0_0 fetch_abm
       (.M_ABM_ARADDR(fetch_abm_M_ABM_ARADDR),
        ...
        .clk(source_100mhz_sys_clk),
        .force_smem_update(force_cache_update_1),
        .resetn(source_100mhz_sys_resetn),
        .select_hsi(select_hsi_1),
        .smem_data0(fetch_abm_smem_data7),
        .smem_data1(fetch_abm_smem_data6),
        ...
        .smem_spi_idle(sim_writer_spi_complete),
        .smem_spi_ready(sim_writer_spi_complete),
